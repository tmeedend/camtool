...
require('tests/test_pitlane')
require('tests/test_cars')
require('tests/test_mix')
require('tests/test_mouselook')
require('tests/test_cutfade')
require('tests/test_settings')
require('tests/test_pitview')
require('tests/test_session_keys')
require('tests/test_recorder')
require('tests/test_timelist')
require('tests/test_tracking')
require('tests/test_spline')
require('tests/test_seek')
require('tests/test_navigate')
require('tests/test_shortcuts')
require('tests/test_trackmap')
require('tests/test_track_adapter')
require('tests/test_sections')
require('tests/test_ruler')
require('tests/test_filename')
require('tests/test_manifest')
